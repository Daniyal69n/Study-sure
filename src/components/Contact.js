    ...
    <div className="bg-gray-50 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Contact Information Section - Shows first on mobile, second on desktop */}
          <div className="space-y-8 order-1 lg:order-2">
            <div>
              ...
              <h2 className="font-bold text-[#034833] leading-tight" 
                  style={{
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  >
                    Plaza No-11, DHA-II, G.T. Road, near Giga Mall, Rawalpindi
                  </a>
                </div>
              </div>
            </div>
          ...
          {/* Contact Form Section - Shows second on mobile, first on desktop */}
